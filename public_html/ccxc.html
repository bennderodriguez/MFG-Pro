...
<html>
    ...
    <body>
        ...
        <div id="footer">
            <script>
                var thispage = "i-arcsiq.p";
                var opciones = JSON.parse(localStorage.getItem("Opciones"));
                var opciones2 = JSON.stringify(opciones);
                if(!opciones2.includes("ccxc.p")){
            ...
            <script>
                ...
                $("#MonedasRep").click(function () {
                    ...
                    xmlhttp.open("GET", mfg_rockjs + "/?action=getMoneda&jwt=" + jwt.toLocaleString(), true);
            ...
            <script>
                ...
                $("#Clientes").click(function () {
                    ...
                    xmlhttp.open("GET", mfg_rockjs + "/?action=getCliente&jwt=" + jwt.toLocaleString(), true);
                    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                    xmlhttp.send("jwt=" + dbParam);
                });
